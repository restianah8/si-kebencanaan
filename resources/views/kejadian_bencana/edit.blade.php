                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group">
                                                    <label for="meninggal">meninggal:</label>
                                                     <input type="text" name="meninggal" value="{{ $kejadian_bencana->meninggal }}"
                                                     id="meninggal" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="hilang">hilang:</label>
                                                    <input type="text" name="hilang" value="{{ $kejadian_bencana->hilang }}"
                                                    id="hilang" class="form-control" required="required">
                                               </div>
                                           </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" name="mengungsi" value="{{ $kejadian_bencana->mengungsi }}"
                                                   id="mengungsi" class="form-control" required="required">
                                               </div>
                                           </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" name="terdampak" value="{{ $kejadian_bencana->terdampak }}"
                                                   id="terdampak" class="form-control" required="required">
                                               </div>
                                           </div>
                                           <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="penyebab" value="{{ $kejadian_bencana->penyebab }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="upaya" value="{{ $kejadian_bencana->upaya }}"
                                                         id="upaya" class="form-control" required="required">
                                                   </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
