            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <div id="pay-invoice">
                          <div class="card-body">
                              <form action="{{ route('peringatan.tambah') }}" method="post" novalidate="novalidate">
                                @csrf
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-7">
                                     <div class="form-group">
                                        <label for="jam">jam:</label>
                                         <input type="time" name="jam" id="jam" class="form-control" required="required">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                     <div class="form-group">
                                ...
                                <div class="col-md-7">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="level" id="level" class="form-control" required="required">
                                    </div>
                                </div>
